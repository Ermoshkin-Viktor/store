...
namespace Store.Tests
{
    public class BookServiceTests
    {
        ...
        public void GetAllByQuery_WithIsbn_CallsGetAllByIsbn()
        {
            ...
            //Поиск по автору
            [Fact]
              void GetAllByQuery_WithAuthor_CallsGetAllByTitleOrAuthor()
            {
                //заглушка для BookRepository
                var bookRepositoryStub = new Mock<IBookRepository>();
                //если будет вызываться метод GetAllByIsbn с любым строковым параметром
            ...
            [Fact]
             void GetAllByQuery_WithIsbn_CallsGetAllByIsbn()
            {
            ...
            [Fact]
             void GetAllByQuery_WithTitle_CallsGetAllByTitleOrAuthor()
            {
                const int idOfIsbnSearch = 1;
                const int idOfAuthorSearch = 2;
